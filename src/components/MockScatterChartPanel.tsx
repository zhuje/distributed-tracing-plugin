...
export function ScatterChartPanel(props: ScatterChartPanelProps) {
  ...
  console.log('ScatterChartPanel CheckPoint 1')

  console.log('ScatterChartPanel Checkpoint 1 > traceResults: ', traceResults)


  if (traceIsLoading === true || traceResults.length < 1 ) {
    return (
      <Box
  ...
  console.log('ScatterChartPanel CheckPoint 2')
  ...
  const series = useMemo(() => {
    ...
    const data:any = traceResults.map((traceArray) => traceArray.data.traces.map((trace) => [trace.startTimeUnixMs, trace.durationMs]))
    ...
    for (let i = 0; i < dataset.length; i++) {
      series.push({ ...seriesTemplate, datasetIndex: i, data });
    }
    return series;
  }, [dataset, defaultColor]);

  console.log('ScatterChartPanel CheckPoint 3')
  ...
  console.log('ScatterChartPanel CheckPoint 4')
  ...
  console.log('ScatterChartPanel CheckPoint 5')


  if (contentDimensions === undefined) return null;


  console.log('ScatterChartPanel CheckPoint 6')
...
//   }
  ...
  console.log('ScatterChartPanel CheckPoint 7')


  console.log('ScatterChartPanel CheckPoint 2 > dataset : ', dataset)
  console.log('ScatterChartPanel CheckPoint 3 > series : ', series)

  console.log('ScatterChartPanel CheckPoint OPTIONS : ', options)
